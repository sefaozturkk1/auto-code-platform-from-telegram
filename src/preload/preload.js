...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    // Mobile Proxy APIs
    getMobileProxyConfig: () => ipcRenderer.invoke('get-mobile-proxy-config'),
    setMobileProxyConfig: (config) => ipcRenderer.invoke('set-mobile-proxy-config', config),
    testMobileProxyIpChange: () => ipcRenderer.invoke('test-mobile-proxy-ip-change'),

    // General Proxy APIs
    getGeneralProxyConfig: () => ipcRenderer.invoke('get-general-proxy-config'),
    setGeneralProxyConfig: (config) => ipcRenderer.invoke('set-general-proxy-config', config),
